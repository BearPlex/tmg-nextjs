...
<div class=" overflow-hidden  px-6 py-24 text-center  sm:px-16">
  ...
  <img src={logo.src} class="items-center"/>
      ...
      <h2 class="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-white sm:text-4xl">Try QUANTUMiND risk-free for 20 days you can even keep the bottles</h2>
      <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">if QUANTUMIND doesn’t transform your life or you don’t feel the difference for up to 20 days since your purchase, email our support team and we’ll give you a complete refund - no questions asked. You can even keep the bottles (limited to one bottle).</p>
                      ...
                      <div class=" px-2 sm:px-0" id="cart-section">
                        <div class="mx-auto  grid max-w-lg grid-cols-1 items-center gap-y-6  sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2 gap-8 ">        
                          ...
                          <img src={bottle.src} alt="" class="rounded-3xl  hover:border-[#15abc9]" />
                          <div class="mx-auto mt-5 max-w-7xl px-6 lg:px-8">
                        <div class="mx-auto max-w-4xl divide-y divide-gray-900/10">
                          <div class="my-8 md:my-0 ">
                            <img src="https://evolvere-repo.s3.us-west-2.amazonaws.com/assets/equilibrium/checkouts%201.svg" alt=""/>
                          </div>
                        </div>
                      </div>
                          </div>
                  ...
                  Subscribe & Save + Free Shipping
                          ...
                          <div class="rounded-3xl p-8 ring-1 ring-gray-900/10 sm:p-10 relative bg-[#F9FAFB] ">
                            ...
                            <p class="mt-4 text-base leading-7 text-gray-700">
                             Premium adaptogenic blend for a calmer, more stress-resilient brain. Take 2-3 capsules per day.
                            </p>
                          ...
                          <input type="radio" name="billing-frequency" value="monthly" id="monthly-radio" checked="" onclick="UpdateButton()"/>
                          ...
                          $48.74 
                            ...
                            <div class="mt-6 relative flex py-3 flex-col bg-[#F9FAFB] border border-[#12ABC9] px-3  rounded-2xl">
                              ...
                              One-time purchase:
                              <input type="radio" name="billing-frequency" value="monthly" id="monthly-radio" onclick="updateButton()"/>
                              </div>
                              <div class="text-[#1B1B1B] font-semibold text-4xl mt-2">
                              $64.99 
                              </div>
                                              ...
                                              <div class="">
                                                <dh-component>
                                                    <div>
                                                        ...
                                                        <a tabindex="0" aria-label="tooltip 3" role="link" class=" rounded-full flex gap-2 items-center relative" onmouseover="showTooltip(3)" onfocus="showTooltip(3)" onmouseout="hideTooltip(3)">
                                                            <div class=" cursor-pointer">
                                                              <img src="https://evolvere-repo.s3.us-west-2.amazonaws.com/assets/equilibrium/Icon%20(16).svg" alt=""/>


                                                            </div>
                                                            <div id="tooltip3" role="tooltip" class="z-20 w-64 absolute transition duration-150 ease-in-out left-0 mt-40 shadow-lg bg-[#FFFFFF] p-4 rounded-[25px] tooltip hidden">
                                                              
                                                                <p class="text-sm font-medium text-[#1B1B1B] pb-1">How subscription works?</p>
                                                                <p class="text-xs leading-4 text-[#1F2937] pb-3">Products are automatically delivered on your schedule. No obligation, modify or cancel your subscription anytime.
                                                                </p>
                                                                <p class="text-xs leading-4 text-[#1F2937] pb-3"><b>Note: </b>  30-Days Money Back Guarantee only applies on first purchase.</p>
                                                                
                                                            </div>
                                                            <div class="font-normal text-sm text-gray-700 whitespace-nowrap cursor-pointer">Subscription Details</div>
                                                        </a>
                                                    </div>
                                                </dh-component>
                                            </div>
                                            ...
                                            <a href="https://youtube.com" id="subscribe-button" class="mt-5 block  py-2.5 px-3.5 text-center text-sm lg:text-lg font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 sm:mt-6 bg-[#12ABC9] text-white shadow-sm rounded-full hover:bg-[#0f9cb9] lg:py-4">Subscribe Now</a>
  ...
  <figure class="">
    ...
    <blockquote class="mt-10 text-xl font-semibold leading-8 tracking-tight text-gray-900 sm:text-2xl sm:leading-9">
      <p>“I’ve taken Adderall when I was in college and this is the best clean supplement you take every single day that enhances your mental creativity, cognition, and everything else that you need to be the best, most successful, positive, healthy, and fit version of yourself so I highly recommend it. Not even making a bold claim here”</p>
    </blockquote>
