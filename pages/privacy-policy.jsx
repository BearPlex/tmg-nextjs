        ...
        <div className="pagePaddingX max-w-7xl mx-auto">
          <div className="mb-14">
            ...
            <p className="paragraphBlack">
              ...
              that they shared and/or collect in The MediaGale. This policy is
            ...
            <div className="my-5">
              ...
              <p className="paragraphBlack">
                ...
                the advertising partners of The MediaGale.
                <div className="py-3" />
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on The
                MediaGale, which are sent directly to users' browser. They
              ...
              <div className="smallHeading text-pink-500 py-4">Contact Us</div>
              <p className="paragraphBlack">
