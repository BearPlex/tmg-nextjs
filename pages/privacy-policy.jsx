    ...
    <div className="pt-20">
      ...
      <div className="max-w-[75%]">
        <div className="pt-52 px-48">
          ...
          <p className="paragraph font-circular-medium">
          ...
          <div className="my-5">
            ...
            >
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
          ...
          <div className="my-5">
            ...
            <p className="paragraphBlack font-circular-medium">
              ...
              of the change and of any new basis under which we have determined
          ...
          <div className="my-5">
            ...
            >
              ...
              <li className="mb-2">
                ...
                <ol
                  type="1"
                  className="marker:smallText list-decimal list-outside pl-4"
                >
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
            ...
            >
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  process this information, for example, by asking you to agree
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  time to time pass your name and contact information to
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  hello@kotacreative.co.uk. However, if you do so, you may not
                ...
                >
                  ...
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                      ...
                      whether you would, in the round, consider it reasonable to
                      do so
                    </span>
                  </li>
                </ol>
                ...
                >
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                      ...
                      of our Kota Creative Ltd
                    </span>
                  </li>
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                      responding to unsolicited communication from you to which
                  ...
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                      ...
                      required to manage Kota Creative Ltd risk
                    </span>
                  </li>
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                      protecting your interests where we believe we have a duty
                      to do so
                    </span>
                  </li>
                </ol>
                ...
                >
                  <li className="mb-2">
                    ...
                    >
                      ...
                      <li className="mb-2">
                        <span className="paragraphBlack font-circular-medium">
                          clicking on an icon next to another visitor’s message
                          to convey your agreement, disagreement or thanks
                        </span>
                      </li>
                    </ol>
                  </li>
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                      ...
                      legal authorities if they so request or if they have the
                      proper authorisation such as a search warrant or court
                      order.
                    </span>
                  </li>
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                      ...
                      satisfy yourself about the privacy level of every person
                      who might use it.
                    </span>
                  </li>
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                      We do not specifically use this information except to
                      allow it to be displayed or shared.
                    </span>
                  </li>
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                  ...
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                      ...
                      control over what any individual third party may do with
                      it. We accept no responsibility for their actions at any
                      time.
                    </span>
                  </li>
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                      ...
                      agree to your request to delete personal information that
                      you have posted. You can make a request by contacting us
                      at hello@kotacreative.co.uk.
                    </span>
                  </li>
                </ol>
              </li>
            ...
            >
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  judgment as to whose right will be obstructed: yours, or that
            ...
            >
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  application, we may keep it for up to years in case we decide
            ...
            >
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  or by e-mail, we collect the data you have given to us in
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  your message, such as your name and email address so as to be
                  able to track our communications with you to provide a high
                  quality service.
                </span>
              </li>
            </ol>
            ...
            >
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  website. They allow information gathered on one web page to be
                  stored until it is needed for use on another, allowing a
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  When you first visit our website, we ask you whether you wish
                  us to use cookies. If you choose not to accept them, we shall
                  not use them for your visit except to record that you have not
              ...
              <li className="mb-2">
                ...
                >
                  ...
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                      to record your answers to surveys and questionnaires on
            ...
            >
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  of the webpages on our website and how we perform in providing
                  content to you.
                </span>
              </li>
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  previous visits, the data possibly could be used to identify
                  you personally, even if you are not signed in to our
                  website.​​
                </span>
              </li>
            </ol>
            ...
            >
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  you browse our website in order to be able to serve to you an
                  advert for our products or services when you visit some other
                  website.
                </span>
              </li>
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  services from time to time. If so, then if you have consented
                  to our use of cookies, you may see advertisements for our
            ...
            >
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  use technology that automatically collects information about
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  JavaScript to personalise the content of, and to measure the
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  that these parties obtain. Accordingly, this privacy notice
                  does not cover the information practices of these third
                  parties.
                </span>
              </li>
            </ol>
            ...
            >
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  reference agencies, so far as it relates to clients or
                  customers who instruct their credit card issuer to cancel
            ...
            >
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  been developed in the United States of America or in
                  Australia.
                </span>
              </li>
              <li className="mb-2">
                ...
                >
                  ...
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
                      ...
                      by a supervisory authority in the European Union
                    </span>
                  </li>
                  <li className="mb-2">
                    <span className="paragraphBlack font-circular-medium">
            ...
            >
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  our website you may send us a request at
            ...
            >
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  identifiable information we shall first take reasonable steps
                  to verify your identity before granting you access or
                  otherwise taking any action. This is important to safeguard
                  your information.
                </span>
              </li>
            </ol>
            ...
            >
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  regardless of age, and we anticipate that some of those users
            ...
            >
              ...
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  symbol or other trust mark in your browser’s URL bar or
                  toolbar.
                </span>
              </li>
            </ol>
            ...
            >
              <li className="mb-2">
                <span className="paragraphBlack font-circular-medium">
                  ...
                  law of every country or legal jurisdiction in which we aim to
                  do business. If you think it fails to satisfy the law of your
