  ...
  return (
   <>
    <section className="pt-20">
                <Header />
      <Section1 work={work[2]?.attributes} featureImage={workFeature} title1st="KINIMO" title2nd="COSMETICS" workHeading="Execute" workDescription1st={workDescription1st} workdescription2nd={workdescription2nd}/>
      <Section2Image work={work[2]?.attributes} imageGallery1={imageGallery1}/>
      <Section3Image work={work[2]?.attributes}/>
      <Section4card/>
  </section>
   </>
  )
