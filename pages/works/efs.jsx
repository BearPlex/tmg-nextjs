  ...
  return (
   <>
    <section className="pt-20">
                <Header />
      <Section1 work={work[6]?.attributes} featureImage={workFeature} title1st="KINIMO" title2nd="COSMETICS" workHeading="Execute" workDescription1st={workDescription1st} workdescription2nd={workdescription2nd}/>
      <Section2Image work={work[6]?.attributes} imageGallery1={imageGallery1}/>
      <Section3Image work={work[6]?.attributes}/>
      <Section4card/>
  </section>
   </>
  )
