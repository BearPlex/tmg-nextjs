                        ...
                        <div key={index} className="w-[47%] mb-16 cursor-pointer" onClick={()=>pushWork(item.id)}>
                            ...
                            <div>
                                <div className="relative work-images h-full">
                                    <img src={item.featured_image.src} alt="work images" className="h-full block max-w-full object-cover" />
                                </div>
                                ...
                                <div className="group">
                                    ...
                                    <HeadingThree title={item.featured_title} cssClass={`my-4 text-2xl ${cssClass} transition group-hover:text-pink-400 group-hover:transition-all`} />
                                    <p className={`${cssClass} text-md font-medium max-w-[90%]`}>{item.gallery_first_description}</p>
                                </div>
                            </div>
                        </div>
                    )
