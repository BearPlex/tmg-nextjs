  ...
  return (
    <div
      ...
      dangerouslySetInnerHTML={{
        __html:
          '<script type="text/javascript" src="https://form.jotform.com/jsform/232724612689059"></script>',
      }}
    />
  );
}
//   useEffect(() => {
//     var ifr = document.getElementById("JotFormIFrame-232262656435457");
//     if (ifr) {
//       var src = ifr.src;
//       var iframeParams = [];
...
//       let iframe; // Declaration added here
