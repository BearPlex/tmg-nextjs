        ...
        <div className="background-gradient z-10 w-full h-full px-20 py-16 fixed top-0">
            <Link href="/">
                <a className="inline-block ">
                    <img src={kotaTransparentImage.src} alt="kota logo" className="inline-block w-40 cursor-pointer" />
                </a>
            </Link>
            <div>
                <ul className="max-w-[60%] mx-auto relative">
                <li className="group">
                        <Link href="/services"><a className="text-[#FFCBC2] inline-block text-[5rem] font-bold leading-none  hover:text-white">Services</a></Link>
                        <div className="hidden group-hover:block">
                            <ul className="absolute top-[50%] translate-y-[-50%]  left-[310px] flex flex-col">
                                <Link href="/service/social-media-marketing"><a className="px-3 text-left text-4xl inline-block font-bold leading-normal text-[#FFCBC2] hover:text-white">Social Media Marketing</a></Link>
                                <Link href="/service/web-design"><a className="px-3 text-left text-4xl inline-block font-bold leading-normal text-[#FFCBC2] hover:text-white">Web Development & Design</a></Link>
                                <Link href="/service/brand-management"><a className="px-3 text-left text-4xl inline-block font-bold leading-normal text-[#FFCBC2] hover:text-white">Branding</a></Link>
                                <Link href="/service/seo"><a className="px-3 text-left text-4xl inline-block font-bold leading-normal text-[#FFCBC2] hover:text-white">Seo</a></Link>
                    ...
                    <li className="group">
                        <Link href="/work"><a className="text-[#FFCBC2] hover:text-white inline-block text-[5rem] font-bold leading-none">Work</a></Link>
                        {/* <div className="hidden group-hover:block">
                    ...
                    <li className="group">
                        <Link href="/studio"><a className="inline-block font-bold text-[5rem] leading-none text-[#FFCBC2] hover:text-white">Studio</a></Link>
                        <div className="hidden group-hover:block">
                            {/* <ul className="absolute top-[50%] translate-y-[-50%]  left-[310px] flex flex-col">
                    ...
                    <li className="group">
                        <Link href="/blog"><a className="inline-block font-bold text-[5rem] leading-none text-[#FFCBC2] hover:text-white">Blog</a></Link>
                        {/* <div className="hidden group-hover:block">
                    ...
                    <li className="group">
                        <Link href="/contact"><a className="inline-block font-bold text-[5rem] leading-none text-[#FFCBC2] hover:text-white">Contact</a></Link>
                        {/* <div className="hidden group-hover:block">
                            <ul className="absolute top-[50%] translate-y-[-50%]  right-[100px] flex flex-col">
                    ...
                    <li className="group">
                        <Link href="/resources"><a className="text-[#FFCBC2] hover:text-white inline-block text-[5rem] font-bold leading-none">Resources</a></Link>
