    ...
    <div className="pt-20 flex items-start justify-between">
      <div className="w-1/2">
        <div className="pb-60 max-w-[80%]">
          <h2
            id="beautyRef"
            className=" heading-style mb-5  text-zinc-700  relative pl-6">
            <sup className="text-sm text-pink-400 font-medium inline-block absolute top-1 left-0">
              01
            </sup>{" "}
            Beauty
          </h2>
        ...
        <div className="pb-60 max-w-[80%]">
          <h2
            id="thoughRef"
            className=" mb-5 font-bold  heading-style relative pl-6">
            <sup className="text-sm text-pink-400 font-medium inline-block absolute top-1 left-0">
              02
            </sup>{" "}
            Thought
        ...
        <div className="pb-60 max-w-[80%]">
          <h2 className=" mb-5  text-zinc-700  relative pl-6 heading-style">
            <sup className="text-sm text-pink-400 font-medium inline-block absolute top-1 left-0">
              03
            </sup>{" "}
            Impact
