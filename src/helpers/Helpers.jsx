...
import featurePortraitImage from '../assets/images/featured-portrait.png';
import featureSquare2Image from '../assets/images/featured-square_2.png';
import featurePortrait1Image from '../assets/images/featured-portrait_1.png';
import littlesImage from '../assets/images/featured-portrait-2.png';
import machoImage from '../assets/images/matchroom-thumbnail-square.png';
import jamiieImage from '../assets/images/jamie-square.png';
import hollandGreenImage from '../assets/images/portrait-features.png';
import featureSquareImage from '../assets/images/featured-square.png';
...
export const articles = [
    ...
    {
        title: '7 must-have features for E-commerce websites.',
        img: blogHeaderImage.src,
        labelExpertise: 'Expertise',
        labelStudios: '',
    }
];
export const blogs = [
    {
        img: websiteImage.src,
        cardTitle: '10 signs you need a new website',
        tags: [
            'Expertise'
        ],
    },
...
export const work = [
    ...
    {
        tabTitle: 'Websites',
        img: featurePortrait1Image.src,
        heading: 'Bounce',
        description: 'We designed a highly animated and playful website for Bounce, the home of ping pong.',
        tags: [
            "Branding",
            "Web Design",
            "Web Development",
    ...
    {
        img: littlesImage.src,
        heading: 'Little\'s Coffee',
        description: 'We designed an E-Commerce platform for Little\'s, a family run coffee business.',
        tags: [
            "Ecommerce",
            "Web Design",
            "Web Development",
    ...
    },
    {
        img: machoImage.src,
        heading: 'Matchroom',
        description: 'We put the punch into one of the biggest sports promoters in the world.',
        tags: [
            "Ecommerce",
            "Web Design",
            "Web Development",
    ...
    },
    {
        ...
        description: 'We created a campaign packed full of impact for Jamie\'s new book, 7 Ways.',
        tags: [
            "Art Direction",
            "Video",
            "Marketing"
    ...
    {
        img: hollandGreenImage.src,
        heading: 'HollandGreen',
        description: 'For the second time, this multi-disciplinary residential practice trusted us to transform their website.',
        tags: [
            "Web Design",
            "Web Development"
        ],
