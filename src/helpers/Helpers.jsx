...
export const work = [
  ...
  },
  {
    ...
    description:
      "We crafted a beautiful website for the boutique yacht brokerage, SuperYachtsMonaco.",
    tags: ["Web Design", "Web Development"],
  },
  {
    ...
    description:
      "We created a cutting edge platform for San Francisco-based firm Martin Building.",
  ...
  },
  {
    ...
    heading: "Bounce",
    description:
      "We designed a highly animated and playful website for Bounce, the home of ping pong.",
    tags: ["Branding", "Web Design", "Web Development"],
  },
  {
    ...
    description:
      "We designed an E-Commerce platform for Little's, a family run coffee business.",
  ...
  },
  {
    ...
    heading: "Matchroom",
    description:
      "We put the punch into one of the biggest sports promoters in the world.",
    tags: ["Ecommerce", "Web Design", "Web Development"],
  },
  {
    img: jamiieImage.src,
    ...
    description:
      "We created a campaign packed full of impact for Jamie's new book, 7 Ways.",
    tags: ["Art Direction", "Video", "Marketing"],
  },
  {
    img: hollandGreenImage.src,
    heading: "HollandGreen",
    description:
      "For the second time, this multi-disciplinary residential practice trusted us to transform their website.",
    tags: ["Web Design", "Web Development"],
  },
];
export const agency = [
...
export const twitterSvg = () => (
  ...
  >
    <g id="Group_385" data-name="Group 385" transform="translate(-239 -664)">
      <g
        id="Ellipse_2"
        data-name="Ellipse 2"
...
export const instagramSvg = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g id="Group_383" data-name="Group 383" transform="translate(-300 -664)">
      <g
        id="Ellipse_3"
        data-name="Ellipse 3"
...
export const facebookSvg = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g id="Group_384" data-name="Group 384" transform="translate(-360 -664)">
      <g
        id="Ellipse_4"
        data-name="Ellipse 4"
...
export const whatsappSvg = () => (
  <svg
    height="60"
    width="60"
    viewBox="-200 0 650 340"
    xmlns="http://www.w3.org/2000/svg"
  >
    <g fill="none" stroke="#878787"></g>
    <path
      fill="#878787"
      stroke="#878787"
      strokeWidth="2"
